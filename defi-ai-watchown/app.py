...
with st.sidebar:
    ...
    # Removed the "Built in GitHub Codespaces" text here!
    ...
    if not wallet_input:
        ...
        try:
            ...
            with st.status("🕵️‍♂️ Agent is investigating...", expanded=True) as status:
                ...
                txs = get_recent_transactions(wallet_address, count=100)
            ...
            # Using native markdown so it reads like a natural text document 
            # and automatically adapts to your Light/Dark theme!
            st.markdown(report)
